...
class Paths:
    def __init__(self):
        ...
        self.bigram_model_filepath       = os.path.join(self.models, 'bigram_model_all') # bigram.model
        self.trigram_model_filepath      = os.path.join(self.models, 'trigram_model_all') # trigram.model
        self.trigram_dictionary_filepath = os.path.join(self.models, 'trigram_dict_all.dict')
        self.trigram_bow_filepath        = os.path.join(self.models, 'trigram_bow_corpus_all.mm')
    ...
    def get_lda_filepath(self, n_topics):
        return os.path.join(self.models, 'lda', 'lda.n' + str(int(n_topics)) + '.model')

    def get_ldaviz_filepath(self, n_topics):
        return os.path.join(self.models, 'ldaviz', 'ldaviz.n' + str(int(n_topics)) + '.model')
    ...
    def get_lda_index(self, n_topics):
        return os.path.join(self.models, 'similarity', 'similarity.n' + str(int(n_topics)))
    ...
    def get_lsa_filepath(self, n_topics):
        return os.path.join(self.models, 'lsa', 'lsa.n' + str(int(n_topics)) + '.model')

    def get_lsa_index(self, n_topics): # TODO merge to create general index path function
        return os.path.join(self.models, 'similarity', 'similarity_lsa.n' + str(int(n_topics)))
